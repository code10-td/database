-- 8.	Discussion-1 — Basic Data Retrieval from Pubs Database Using MySQL SELECT Statement (Knowing table names, Showing records, Ordering, Aggregate values, Group By, Having, Formatted strings)
