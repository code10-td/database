-- 5.	Study and Implementation of MySQL Commands of Join Operations with Example (Cartesian Product, Natural Join, Left Outer Join, Right Outer Join, Full Outer Join)
