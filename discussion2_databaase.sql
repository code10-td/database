-- 9.	Discussion-2 — Table Joining, Nested Query in Pubs Database and Table Creation with Constraints in CustomerAndSuppliers, Items and Transactions Tables Using MySQL.
-- Database
